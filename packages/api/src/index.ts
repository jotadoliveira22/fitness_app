...
export { DataAccessError, NotFoundError, SafetyBlockedError } from "./data-access/errors.js";

// Safety / Rules Layer (SPEC §35.2)
export {
  screenFreeText,
  evaluateFreeText,
  ...
  type SafetySeverity,
  type SafetyOutcome,
} from "./safety/safety-layer.js";
export { recordSafetyFlags } from "./data-access/safety-flags.repository.js";
export {
