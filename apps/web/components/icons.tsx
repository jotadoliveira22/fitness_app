...
export function ChartBarIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M5 20V13M12 20V7M19 20v-5" />
    </svg>
  );
}
...
export function EyeOffIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.1A10.7 10.7 0 0 1 12 5c6.5 0 10 7 10 7a15.6 15.6 0 0 1-3.2 4.1M6.5 6.6C3.4 8.5 2 12 2 12s3.5 7 10 7c1.4 0 2.6-.3 3.7-.8" />
...
export function AppleIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M16.36 1.44c0 1.13-.42 2.1-1.26 2.94-.9.9-2 1.42-3.16 1.32a3.62 3.62 0 0 1 1-2.72c.93-.99 2.15-1.5 3.42-1.54Zm3.43 16.6c-.3.7-.66 1.34-1.08 1.94-.58.84-1.06 1.42-1.42 1.74-.56.53-1.16.8-1.8.82-.46.01-1.02-.13-1.66-.42-.65-.29-1.24-.43-1.79-.43-.56 0-1.17.14-1.83.43-.66.29-1.19.44-1.6.46-.62.03-1.24-.25-1.86-.83-.4-.35-.9-.95-1.51-1.81-.65-.92-1.19-1.99-1.61-3.21-.45-1.32-.68-2.6-.68-3.83 0-1.42.31-2.64.92-3.67a5.42 5.42 0 0 1 1.94-1.97 5.22 5.22 0 0 1 2.62-.74c.49 0 1.14.15 1.94.45.8.3 1.31.45 1.53.45.16 0 .73-.18 1.7-.53.92-.32 1.69-.46 2.32-.4 1.72.14 3.01.82 3.87 2.05a4.97 4.97 0 0 0-2.35 4.17c.02 1.53.57 2.8 1.66 3.79.49.47 1.04.83 1.65 1.09-.13.38-.27.75-.42 1.1Z" />
    </svg>
  );
}
...
export function KettlebellFilledIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M6.52,0.38 L4.64,1.78 L3.61,3.98 L3.8,6.52 L5.67,9.66 L3.98,11.81 L3.05,14.3 L2.86,16.88 L3.61,19.92 L5.11,22.27 L7.08,23.95 L16.88,23.95 L19.69,21.14 L21,17.67 L21.05,15.14 L20.53,13.03 L18.28,9.66 L20.2,6.38 L20.39,4.31 L20.06,3.05 L18.61,1.08 L16.31,0.05 L8.02,0 Z" />
      <path d="M7.73,4.69 L8.3,4.17 L15.66,4.17 L16.12,4.5 L16.22,5.11 L14.67,7.5 L12.61,7.12 L9.28,7.5 Z" fill={NAV_CUTOUT} />
    </svg>
  );
}
